...
<div class="font-sans antialiased h-screen flex">
  ...
  <div class="bg-gray-800 text-purple-lighter flex-none w-64 pb-6 hidden md:block">
    ...
    <div class="text-white mb-2 mt-3 px-4 flex justify-between py-3 border-b border-gray-700">
      <div class="flex-auto">
        <h1 class="font-semibold text-xl leading-tight mb-1 truncate">Jet Panda</h1>
      </div>
    </div>
    
    <div class="mb-8">
      <div class="px-4 mb-2 text-white flex justify-between items-center">
        <div class="opacity-75 cursor-pointer">Счета</div>
      </div>
    </div>
    
    <div class="mb-8">
      <div class="px-4 mb-2 text-white flex justify-between items-center">
        <div class="opacity-75 cursor-pointer">Организации</div>
      </div>
    </div>
